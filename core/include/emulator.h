...
public:
    ...
    bool try_load_file_to_memory(std::filesystem::path file_path, bool is_bootrom_file, std::string &error_message, bool TODO_REMOVE_AFTER_MBC_1_5_IMPLEMENTED = false);
